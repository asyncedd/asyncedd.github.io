			...
			<ul>
				<div class="h-[50vh] flex flex-col items-center justify-center py-[50vh]">
					<li class="">
						<a
							href="/"
							class="flex gap-3 text-content fill-content hover:fill-yellow-500 hover:dark:fill-sky-500 hover:text-yellow-500 hover:dark:text-sky-500 transition-colors duration-[0.5s]"
					...
					<li>
						<a
							...
							class="flex gap-3 text-content fill-content hover:fill-[#6e5494] hover:dark:fill-[#6e5494] hover:text-[#6e5494] hover:dark:text-[#6e5494] transition-colors duration-[0.5s]"
					...
					<li>
						<a
							...
							class="flex gap-3 text-content fill-content hover:fill-[#6666ff] hover:dark:fill-[#6666ff] hover:text-[#6666ff] hover:dark:text-[#6666ff] transition-colors duration-[0.5s]"
					...
					<li>
						<a
							href="/blog"
							class="flex gap-3 text-content fill-content hover:fill-green-500 hover:dark:fill-green-500 hover:text-green-500 hover:dark:text-green-500 transition-colors duration-[0.5s]"
