...
<div class="w-[100%] dark:bg-ctp-base bg-ctp-blue overflow-auto navbar flex top-0 z-50">
	...
	<div class="flex">
		<div class="text-[30px] a-icons icon-wrapper mx-[30px] mt-[10px]">
			<ThemeSwitch />
		</div>
		<a
			...
			aria-label="Discord"
		>
			<div class="icon-wrapper a-icons discord hover:fill-[#6666ff] fill-ctp-text">
		...
		<a
			...
			aria-label="Github"
		>
			<div class="icon-wrapper a-icons github fill-ctp-text hover:fill-[#fafafa]">
