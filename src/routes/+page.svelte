...
>
	<div class="dark:bg-ctp-base bg-ctp-blue">
		<Navbar />
		<div class="h-[100vh] flex justify-center items-center dark:text-ctp-text text-ctp-base">
			<div
				...
				<div class="order-last sm:order-first h-[20vh] w-auto overflow-none my-1 min-w-15">
					...
					<div class="flex">
						<div class="inline-flex justify-center items-center align-middle mx-[35%]">
							...
							>
								<div
									class="icon-wrapper a-icons discord hover:fill-[#6666ff] dark:fill-ctp-text fill-ctp-base hover:dark:fill-[#6666ff]"
								>
		...
		<footer class="dark:bg-ctp-base bg-ctp-blue text-center">
			...
			<p class="text-center text-[0.9rem] p-[0.3rem]">
				The main image is shot by <a
					class="dark:text-ctp-blue text-ctp-rosewater hover:text-ctp-sky transition-colors duration-150"
