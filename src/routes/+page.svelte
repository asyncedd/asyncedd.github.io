<article
	class="h-[100svh] flex justify-center flex-col text-left items-center -mt-[calc(3rem+clamp(0.5rem,0.5rem+3vw,3rem))] m-auto"
>
	<div class="relative">
		...
		<div class="flex w-full">
			...
			>
				<svg
					viewBox="0 0 24 24"
					class=" w-[clamp(16px,16px+0.5vw,32px)] h-[clamp(16px,16px+0.5vw,32px)]"
					><path
