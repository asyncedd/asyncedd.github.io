...
>
	<div class="relative">
		<h2
			class="text-foreground_dark/85 break-words font-['Montserrat'] text-[clamp(1.8rem,1.8rem+1vw,3.3rem)] uppercase"
		>
			<b
				>hi, i'm <span
					class="bg-gradient-to-r from-teal-500 via-blue-500 to-purple-500 bg-clip-text text-transparent dark:from-teal-400 dark:via-blue-400 dark:to-purple-400"
					>asyncedd.</span
				></b
			>
		</h2>
		<p class="text-[clamp(1.3rem,1.3rem+1vw,1.6rem)] tracking-wider text-foreground_dark/80">
		...
		<div class="flex w-full">
			<a
				...
				target="_blank"
				class="fill-foreground_dark opacity-[0.7] transition-[opacity] duration-[0.3s] ease-in-out hover:opacity-[1]"
			>
				<svg viewBox="0 0 24 24" class=" h-[32px] w-[32px]"
					><path
