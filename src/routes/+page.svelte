...
>
	<div class="relative">
		<h2 class="text-foreground_dark/85 break-words text-[clamp(3rem,3rem+1vw,4.5rem)] uppercase">
			<b
				>hi, i'm <span
		...
		<p class="text-foreground/85 text-[clamp(1.3rem,1.3rem+1vw,1.6rem)] tracking-wider">
