...
<div
	class="h-[100vh] flex justify-center items-center align-middle text-foreground pb-[5rem] sm:pb-0 bg-background ease-in-out"
>
	<div class="flex items-center">
		<div class="py-[10vh]" style="max-inline-size: 100%; margin-inline: auto;">
			...
			<a class="flex justify-center text-[3rem]" href="/">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					height="1em"
					viewBox="0 0 576 512"
					class="fill-foreground hover:fill-accent transition-[fill] duration-[0.5s] ease-in-out"
					><path
