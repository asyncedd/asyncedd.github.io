	...
	<div class="grid uppercase text-[clamp(1.9rem,1.9rem+3vw,3.3rem)]">
		...
		<a href="/" class="inline-flex items-center gap-3 group">
			<svg
				...
				class="fill-foreground/50 group-hover:fill-foreground transition-[fill] duration-[0.3s] ease-in-out"
				><path
			...
			>
			<p
				class="text-[clamp(0.5rem,0.5rem+3vw,1.9rem)] tracking-widest uppercase text-foreground_dark/75 group-hover:text-foreground transition-[color] duration-[0.3s] ease-in-out"
			>
				Go back
			</p>
		</a>
