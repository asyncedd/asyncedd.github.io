			...
			<div class="mx-[5px] inline-flex justify-between w-[calc(100%-70px)]">
				<a href="/" aria-label="async" class="inline-flex">
					...
					>
						...
						/>
						<img
							src="https://ik.imagekit.io/7qhojskvo/tr:w-100,cp-false,lo-true,r-256,q-85,f-jpg/clouds_tiny_2k_tiny.jpg?updatedAt=1692574417004"
							width="100"
							height="100"
				...
				<class class="h-[100%] flex items-center">
					<h2 class="text-[1rem] text-center">Made with ❤️ by asyncedd</h2>
				</class>
			</div>
		</div>
		<div class="inline-flex justify-center my-1 w-full">
			<div class="mx-[5px] inline-flex justify-between w-[calc(100%-70px)] ml-[30px]">
				<a
					class="text-[1.5rem] text-foreground_dark/50 hover:text-foreground transition-[color] duration-[0.5s] ease-in-out"
					href="/blog">Blogs</a
				>
			</div>
			<div class="flex justify-end items-center align-middle mr-[30px]">
