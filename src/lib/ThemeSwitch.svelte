...
>
	<div>
		<div class="relative">
			<i class="absolute dark:opacity-100 opacity-0 dark:translate-y-[-10px] translate-y-0"
				...
				></i
			>
			<i class="absolute dark:opacity-0 opacity-100 translate-y-[-10px] dark:translate-y-0"
